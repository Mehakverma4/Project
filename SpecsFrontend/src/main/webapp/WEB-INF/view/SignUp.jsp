...
<body  background="E:\PROJUCTNIIT\SpecsFrontend\src\main\webapp\resources\Images\SignUP.jpg" height="300px" width="300px">
<spring:form action ="${pageContext.request.contextPath}/addCustomer" modelAttribute="customer" method="post">
<form class="login-form">
  ...
  <input type="Number" class="login-username" autofocus="true" required="true" placeholder="Mobile" />
