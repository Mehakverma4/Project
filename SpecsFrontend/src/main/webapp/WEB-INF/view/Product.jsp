...
<c:forEach items="${productList}" var="produ">
<tr>
<td>${produ.productId}</td>
<td>${produ.productName}</td>
<td>${produ.productDesc} </td>
<td>${produ.quantity}</td>
<td>${produ.price }</td> 
<td><a href="<c:out value="editProduct/${produ.productId}"></td>></c:out>">Edit</a>
<td><a href="<c:out value="deleteProduct/${produ.productId}"></td>></c:out>">Delete</a>
</tr>
